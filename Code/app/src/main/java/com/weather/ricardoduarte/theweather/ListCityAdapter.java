...
public class ListCityAdapter extends ArrayAdapter<CityResponse>{
    public ListCityAdapter(@NonNull Context context, List<CityResponse> cities) {
   ...
   /* public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        CityResponse city_item = getItem(position);
